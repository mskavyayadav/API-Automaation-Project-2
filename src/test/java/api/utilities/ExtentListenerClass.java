...
public class ExtentListenerClass implements ITestListener {
	...
	public void configureReport()
	{
		...
		reports.setSystemInfo("user name:", "Mohit");
		
		//configuration to change look and feel of report
		htmlReporter.config().setDocumentTitle("RestAssuredAutomationProject");
		htmlReporter.config().setReportName("Pet Store User API");
